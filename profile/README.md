# 🧠 EEG-DaSh: Open Data, Tools & Compute for Brain Signals
...
### 2025 NeurIPS Foundation Challenge
...
- [Challenge details & starter kits](https://eeg2025.github.io/) | [ArXiv paper](https://arxiv.org/abs/2506.19141)
...
- **Processing**: [BrainDecode](https://braindecode.org/) (PyTorch), [EEGPrep](https://eeglab.org/), [MNE-Python](https://mne.tools/stable/index.html)

## 📖 Getting Started

1. **Browse datasets**: [Visit the portal](https://eegdash.org)
3. **Code examples**: PyTorch Lightning + Google Colab notebooks included

## 📑 Learn More

- **Database Paper**: [EEG-DaSh: An Open Data, Tool, and Compute Resource](https://www.biorxiv.org/) (in review)
- **Docs & Tutorials**: [Full documentation](https://eegdash.org/)

## 🌍 Organizing Institutions

<table>
  <tr>
    <td align="center"><img src="https://eeg2025.github.io/assets/logos/ucsd.png" width="80"><br/>UC San Diego</td>
    <td align="center"><img src="https://eeg2025.github.io/assets/logos/ben_logo.png" width="80"><br/>Ben-Gurion Univ.</td>
  </tr>
</table>
...
*Got data to share? See our Github page. Have feedback? [Open an issue](https://github.com/sccn/EEGDash/issues).*
